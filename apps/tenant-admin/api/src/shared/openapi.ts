            ...
            schemas: {
                ...
                MenuItem: {
                    ...
                    properties: {
                        ...
                        item_type: { type: 'string', enum: ['STANDARD', 'COMBO'] },
                        track_stock: { type: 'boolean' },
                        stock_quantity: { type: 'integer', nullable: true },
                        low_stock_threshold: { type: 'integer', nullable: true },
                        availability_windows: {
                            type: 'array',
                            items: { $ref: '#/components/schemas/MenuItemAvailabilityWindow' },
                            nullable: true,
                        },
                        option_groups: {
                            type: 'array',
                            items: { $ref: '#/components/schemas/MenuItemOptionGroup' },
                            nullable: true,
                        },
                        combo_components: {
                            type: 'array',
                            items: { $ref: '#/components/schemas/MenuItemComboComponent' },
                            nullable: true,
                        },
                        is_currently_available: { type: 'boolean' },
                        current_availability_status: { type: 'string', enum: ['available', 'low_stock', 'manual_inactive', 'out_of_stock', 'scheduled_unavailable'] },
                        current_availability_label: { type: 'string' },
                        ...
                        combo_component_count: { type: 'integer' },
                        configuration_summary: { type: 'string' },
                ...
                MenuItemAvailabilityWindow: {
                    type: 'object',
                    properties: {
                        day_of_week: { type: 'integer', minimum: 0, maximum: 6 },
                        start_time: { type: 'string', example: '18:00' },
                        end_time: { type: 'string', example: '23:30' },
                    },
                },
                MenuItemOption: {
                    type: 'object',
                ...
                MenuItemComboComponent: {
                    ...
                    properties: {
                        ...
                        menu_item_price: { type: 'number', nullable: true },
