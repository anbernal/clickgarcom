...
Arquivos relevantes:
- `services/node-admin/src/shared/message-templates.ts`
- `services/node-admin/src/entities/tenant.entity.ts`
- `services/go-core/internal/domain/tenant/entity.go`
- `services/go-core/internal/application/handle_whatsapp_message.go`
...
- `services/node-admin/src/modules/bot-config/`
...
- `services/go-core/internal/domain/botconfig/`
...
Infra:
- `services/go-core/internal/infrastructure/persistence/postgres/botconfig_repository.go`
