...
type MessageLog struct {
	...
	UserPhone      string           `json:"user_phone" gorm:"column:user_phone;type:varchar(30)"`
	MessagePreview string           `json:"message_preview" gorm:"column:message_preview;type:varchar(255)"`
