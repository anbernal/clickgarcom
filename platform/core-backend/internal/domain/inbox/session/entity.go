...
const (
	...
	StateAdjustingOrderItem       ConversationState = "ADJUSTING_ORDER_ITEM"
	StateSelectingCartItemQty     ConversationState = "SELECTING_CART_ITEM_QTY"
	...
	StateDeliveryCustomerName        ConversationState = "DELIVERY_CUSTOMER_NAME"
