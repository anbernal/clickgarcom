...
// OutputStore persists portal-visible responses generated by the engine.
type OutputStore interface {
	AppendOutput(ctx context.Context, tenantID, tabID uuid.UUID, output Output) error
}

// InputStore persists inbound customer events for portal-visible conversations.
type InputStore interface {
	AppendInput(ctx context.Context, tenantID, tabID uuid.UUID, input Input) error
}
